...
import numpy as np
try:
    from HW5_code.im2col_cython import col2im_cython, im2col_cython
    from HW5_code.im2col_cython import col2im_6d_cython
except ImportError:
    print('run the following from the HW5_code directory and try again:')
    print('python setup.py build_ext --inplace')
    print('You may also need to restart your iPython kernel')

from HW5_code.im2col import *
